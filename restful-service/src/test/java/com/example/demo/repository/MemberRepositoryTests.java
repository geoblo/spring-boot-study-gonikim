...
public class MemberRepositoryTests {
    ...
    public void testUserCase1() {
        ...
        assertThat(memberRepository.findByNameAndEmail("윤서준", "SeojunYoon@goodee.co.kr").size()).isEqualTo(1);

        // 이름이 '윤서준'이거나 또는 이메일이 'KwangcheolYoon@goodee.co.kr'인 사용자를 조회한 결과 개수가 2인지 검증
        assertThat(memberRepository.findByNameOrEmail("윤서준", "KwangcheolYoon@goodee.co.kr").size()).isEqualTo(2);
