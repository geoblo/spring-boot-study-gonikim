...
public class HomeController {
    ...
    // POST /login, POST /logout은 스프링 시큐리티가 처리하므로 우리가 구현할 필요 X
    @GetMapping("/login")
    ...
    // POST /signup에서 폼을 검증하고 입력된 값을 다시 보여 주기 위해
    ...
    public String postMemberAdd(
        ...
        // 이름과 이메일 검증은 폼 검증 어노테이션을 사용해 검증한 후에 그 결과를 BindingResult로 전달받음
        ...
        // 입력된 이메일로 회원을 조회하고, 이미 사용 중인 이메일이면 
